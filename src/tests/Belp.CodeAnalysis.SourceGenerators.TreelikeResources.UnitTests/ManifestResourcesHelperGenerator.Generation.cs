using SGTest = Belp.Tests.CodeAnalysis.SourceGenerators.CSharpIncrementalSourceGeneratorVerifier<Belp.CodeAnalysis.SourceGenerators.TreelikeResources.ManifestResourcesHelperGenerator>.Test;
        ...
        public Task Generates_ManifestResourcesHelper()
        {
            var test = new SGTest
            {
                TestState =
                {
                    ...
                    {
                        (
                            typeof(TreelikeResources.ManifestResourcesHelperGenerator),
