using SGTest = Belp.Tests.CodeAnalysis.SourceGenerators.CSharpIncrementalSourceGeneratorVerifier<Belp.CodeAnalysis.SourceGenerators.ManifestResourceGenerators.ManifestResourcesGenerator>.Test;
                ...
                TestState =
                {
                    ...
                    AnalyzerConfigFiles =
                    {
                        (
                            ...
                            build_metadata.AdditionalFiles.TargetSourceGenerator = Belp.CodeAnalysis.SourceGenerators.ManifestResourceGenerators.ManifestResourcesGenerator
                            """
                        ),
                    },
